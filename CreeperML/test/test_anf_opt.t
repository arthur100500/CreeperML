...
+-----------------------------+
  ...
  > EOF
  let (9) (35) (36) (37) = 
    let (33) = v(4) v(37) v(36)
    let (34) = v(4) v(33) v(35)
    v(34)
  
  let (10) (39) (40) = 
    let (38) = v(9) v(39) v(40)
    v(38)
  
  let (41) = v(10) l(10) l(11)
...
+--------------------------------+
  ...
  let (19) (173) (174) (175) (176) (177) (178) = 
    let (167) = v(3) v(174) v(175)
    let (168) = v(4) v(173) v(167)
    let (169) = v(3) v(176) v(177)
    let (170) = v(2) v(168) v(169)
    let (171) = v(3) l(2) v(178)
    let (172) = v(4) v(170) v(171)
    v(172)
  
  let (20) (180) (181) (182) = 
    let (179) = v(19) v(180) v(181) v(182)
    v(179)
  
  let (183) = v(4) v(159) v(159)
  
  let (184) = v(20) l(10) l(11) l(12) l(13) l(14) l(15)
  
  let (185) = v(4) v(183) v(184)
  
  let (186) = v(20) l(55) l(66) l(77) l(88)
  
  let (187) = v(4) v(157) v(159)
  
  let (188) = v(2) v(187) v(159)
  
  let (189) = v(12) l(19)
  
  let (190) = v(186) v(163) v(189)
  
  let (191) = v(3) v(159) v(190)
  
  let (192) = v(4) v(188) v(191)
  
  let (193) = v(4) v(192) v(185)
